...
function SignUp() {
  ...
  return (
    <div className="flex justify-center items-center m-4 ">
      <section className="w-full sm:w-1/2 md:w-fit  bg-[rgba(47,_163,_177,_0.2)] rounded-[16px] [box-shadow:0_4px_30px_rgba(0,_0,_0,_0.1)] backdrop-filter backdrop-blur-[5px] border-[1px] border-[rgba(47,163,177,0.3)]">
